...
public class MyFriendRequest {
    ...
    public MyFriendRequest() throws SQLException {
    }
    @FXML
    private void initialize() throws SQLException, RepositoryException {
        ...
        {
            if (Objects.equals(f.getTo().getId(), id)) {

                Request_list.getItems().add(f.getFrom());
            }
    ...
    public void accept(ActionEvent actionEvent) throws ServiceException, RepositoryException, SQLException {
        ...
        for (User ur: service.getAll()){
            if (Objects.equals(ur.getId(), id)){
                service.removeFr(ur.getUsername(),u.getUsername());
                service.addFriendship(u.getUsername(),ur.getUsername());
            }
        }
        initialize();
    }
